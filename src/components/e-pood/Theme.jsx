        ...
        <>
            ...
            <div className="text-center mb-12  mt-10">
                ...
                <p className="text-gray-700 mt-2 text-lg max-w-3xl mx-auto text-center px-4">
                    E-poest tellimine on lihtne. Lisage toode/tooted ostukorvi ning teid suunatakse edasi ostu sooritama,
                    kus saate ise valida, kas soovite tulla tootele/toodetele ise järele või saadame teile pakiautomaati.
                </p>
